...
object AurixDeepKnowledge {
 private val entries=listOf(
            ...
            AurixAIKnowledgeExpansion.entries,
            AurixAnimalsKnowledgeExpansion.entries,
            AurixAviationKnowledgeExpansion.entries,
            AurixBiologyKnowledgeExpansion.entries,
            AurixBusinessKnowledgeExpansion.entries,
            AurixChemistryKnowledgeExpansion.entries,
            AurixComputerKnowledgeExpansion.entries,
            AurixConstructionKnowledgeExpansion.entries,
            AurixElectronicsKnowledgeExpansion.entries,
            AurixEngineeringKnowledgeExpansion.entries,
            AurixEverydayKnowledgeExpansion.entries,
            AurixFinanceKnowledgeExpansion.entries,
            AurixGeographyKnowledgeExpansion.entries,
            AurixHistoryKnowledgeExpansion.entries,
            AurixHumanBodyKnowledgeExpansion.entries,
            AurixIndiaKnowledgeExpansion.entries,
            AurixMaritimeKnowledgeExpansion.entries,
            AurixMathematicsKnowledgeExpansion.entries,
            AurixPharmaceuticalKnowledgeExpansion.entries,
            AurixPhysicsKnowledgeExpansion.entries,
            AurixPlantsKnowledgeExpansion.entries,
            AurixQualityKnowledgeExpansion.entries,
            AurixSpaceKnowledgeExpansion.entries,
 ).flatten()
